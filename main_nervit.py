...
from modeling_nervit import NERVitModel
from transformers import AutoTokenizer, AutoConfig

MODEL_CLASSES = {
    "bert": (AutoConfig, NERVitModel, AutoTokenizer),
    "roberta": (AutoConfig, NERVitModel, AutoTokenizer)
}
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if args.local_rank == -1 and args.evaluate_during_training:  # Only evaluate when single GPU otherwise metrics may not average well
                        ...
                        results, _ = evaluate(args, model, eval_dataset, labels, pad_token_label_id,
                                              mode="dev", language_code=args.language_code)
...
def main():
    ...
    if args.do_train:
        ...
        valid_dataset = load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode="dev",
                                                language_code=args.language_code)
        ...
        global_step, tr_loss = train(args, model, train_dataset, valid_dataset, tokenizer, labels, pad_token_label_id)
...
#        import pdb;pdb.set_trace()
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        result, predictions = evaluate(args, model, test_dataset, labels, pad_token_label_id,
                                       mode="test",
        ...
        with open(output_test_predictions_file, "w", encoding='utf-8') as writer:
            with open(os.path.join(args.data_dir, "{}_{}.conll".format(args.language_code, "test")), "r",
                      encoding='utf-8') as f:
                example_id = 0
                for line in f:
